    ...
    <div className="film-card__text film-card__row">
      <div className="film-card__text-col">
        <p className="film-card__details-item">
          ...
          <span className="film-card__details-value">{selectedFilm.overviewDetails.director}</span>
        </p>
        <p className="film-card__details-item">
      ...
      <div className="film-card__text-col">
        <p className="film-card__details-item">
          ...
          <span className="film-card__details-value">{selectedFilm.overviewDetails.duration}m</span>
        </p>
        <p className="film-card__details-item">
